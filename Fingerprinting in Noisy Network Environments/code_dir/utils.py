...
def get_dataset():
    ...
    names = ['dim1','dim2','dim3','dim4','dim5','dim6','dim7','dim8','dim9','dim10','dim11','dim12','dim13','dim14',
             'dim15','dim16','dim17','dim18','dim19','dim20','dim21','dim22','dim23','dim24','dim25','dim26','dim27',
             'dim28','dim29','dim30','dim31','dim32','class']
    ...
    if experiment_type == 1 and c_uc == 1:
        ...
        if accum == 128:
            ...
            names = ['dim1','dim2','dim3','dim4','dim5','dim6','dim7','dim8','dim9','dim10','dim11','dim12','dim13',
                     ...
                     'dim26','dim27','dim28','dim29','dim30','dim31','dim32','class']
        elif accum == 512:
            names = ['dim1','dim2','dim3','dim4','dim5','dim6','dim7','dim8','dim9','dim10','dim11','dim12','dim13',
                     'dim14','dim15','dim16','dim17','dim18','dim19','dim20','dim21','dim22','dim23','dim24','dim25',
            ...
            names = ['dim1','dim2','dim3','dim4','dim5','dim6','dim7','dim8','dim9','dim10','dim11','dim12','dim13',
                     ...
                     'dim38','dim39','dim40','dim41','dim42','dim43','dim44','dim45','dim46','dim47','dim48','dim49',
                     'dim50','dim51','dim52','dim53','dim54','dim55','dim56','dim57','dim58','dim59','dim60','dim61',
                     'dim62','dim63','dim64', 'dim65','dim66','dim67','dim68','dim69','dim70','dim71','dim72','dim73',
                     'dim74','dim75','dim76','dim77','dim78','dim79','dim80','dim81','dim82','dim83','dim84','dim85',
                     'dim86','dim87','dim88','dim89','dim90','dim91','dim92','dim93','dim94','dim95','dim96','dim97',
...
def get_dataset_parameterized(experiment_type=1, c_uc=1, noise=1, device=1, i_ni=1, accum=128, window=4, combo=2):
    names = ['dim1','dim2','dim3','dim4','dim5','dim6','dim7','dim8','dim9','dim10','dim11','dim12','dim13','dim14',
             'dim15','dim16','dim17','dim18','dim19','dim20','dim21','dim22','dim23','dim24','dim25','dim26','dim27',
             'dim28','dim29','dim30','dim31','dim32','class']
...
def get_dataset_parameterized_auto_select(noise, noise_c_uc, device, device_c_uc, device_i_ni, accum, window, combo):
    ...
    if not device_c_uc in [1, 2]:
        raise ValueError("'device_c_uc' parameter must be one of the following values: 1 or 2.")
    if device_c_uc == 1:
